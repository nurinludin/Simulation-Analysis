...
Analysis_08212017.(char(ne{i}))=Run(Loc); %,Analysis.(char(ne{i})) );
end
...
Analysis_08212017.Names(i,:)=ne(i);
Analysis_08212017.Overview(i,1:3)=Analysis_08212017.(char(ne{i})).Ca(2,:);
Analysis_08212017.Overview(i,4:6)=Analysis_08212017.(char(ne{i})).Ca(1,:);
